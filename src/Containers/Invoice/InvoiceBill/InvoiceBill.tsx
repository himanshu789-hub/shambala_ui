...
import { IInvoiceBillingDTO } from "Types/DTO";
...
type DisplayInvoiceBillProps = {
    InvoiceBillDetail: IInvoiceBillingDTO;
    ToggleModal(): void;
    ShowModal: boolean;
}
function DisplayInvoiceBill(props: DisplayInvoiceBillProps) {
    ...
    return (<div>
        <Heading label="Invoice Bill" />
        <div className="bill-info p-2">
            <fieldset disabled>
                <div className="row">
...
function InvoiceBill(props: IInvoiceBillProps) {
    const [bill, setInvoiceBill] = useState<IInvoiceBillingDTO>();
