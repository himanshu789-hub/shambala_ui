...
export default class OutgoingMediator implements IQuantityMediatorWrapper  {
    ...
    constructor(quantityLimit:number) {
            this.quantityMediator = new QuantityMediator([{CaretSize:12,Flavours:[{Id:1,Quantity:quantityLimit,Title:''}],Id:1,Name:'',PricePerCaret:0,SchemeQuantity:0,PricePerBottle:0}]);
    }
    GetQuantityLimit(): number {
